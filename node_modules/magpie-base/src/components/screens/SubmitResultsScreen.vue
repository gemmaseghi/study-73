...
export default {
  ...
  methods: {
    ...
    redirectToCompletionUrl() {
      console.log('redirectToCompletionUrl called');
      console.log('survey code inside submit screen:', this.$surveyCode);
      console.log('current URL:', window.location.href);

      // Prolific
      if (this.$magpie.mode === 'prolific' && this.$magpie.completionUrl) {
        console.log('Redirecting to Prolific:', this.$magpie.completionUrl);
      ...
      if (this.$surveyCode) {
        ...
        console.log('Redirecting to Sona:', url.toString());

        window.location.assign(url.toString());
      } else {
        console.error('No Sona survey code found in SubmitResultsScreen');
      }
    }
  }
};
